#famous-connect-js
> Famo.us: The Future of the Mobile Web? - Connect.JS 2014 Talk.

[![Build Status](https://travis-ci.org/chalaschek/famous-connect-js.svg?branch=master)](https://travis-ci.org/chalaschek/famous-connect-js) [![Dependency Status](https://david-dm.org/chalaschek/famous-connect-js.svg)](https://david-dm.org/chalaschek/famous-connect-js) [![devDependency Status](https://david-dm.org/chalaschek/famous-connect-js/dev-status.svg)](https://david-dm.org/chalaschek/famous-connect-js#info=devDependencies)
